...
// CORS first so all responses have CORS headers
app.use(
  cors({
...
app.use("/api/cakes", require("./routes/cakePreorder")); // Cake preorder pincode/district matching
app.use("/api/profile", require("./routes/userProfile")); // User profiles and social features
// Health route already mounted above (before body parsers) for multipart support
