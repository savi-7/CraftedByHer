      ...
      <div className={`bk-header__main ${isSimplifiedHeaderPage ? 'simplified' : ''}`}>
        ...
        {!isSimplifiedHeaderPage && (
          <nav className="bk-nav">
            ...
            <Link to="/cakes/preorder" className="bk-link">Preorder Cake</Link>
            {user && (
              <>
                <Link to="/order-planner" className="bk-link">Order Planner</Link>
                <Link to="/orders" className="bk-link">My Orders</Link>
              </>
            )}
            {!user && (
              <Link to="/login" className="bk-link">My Orders</Link>
            )}
          </nav>
        )}
