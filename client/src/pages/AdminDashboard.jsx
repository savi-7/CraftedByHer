                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                  {approvedSellers.map((seller) => {
                    ...
                    return (
                      <div
                        key={seller._id}
                        onClick={() => navigate(`/admin/seller/${seller._id}`, { state: { seller, products: sellerProds } })}
                        style={{
                          background: "var(--accent-soft, #f3e7dc)",
                          borderRadius: "16px",
                          padding: "24px",
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.transform = "translateY(-4px)";
                          e.currentTarget.style.boxShadow = "var(--shadow, 0 16px 32px rgba(63,45,35,.15))";
                      ...
                      >
                        ...
                        <div style={{ 
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              setExpandedSeller(isExpanded ? null : seller._id);
                            }}
                            style={{
                              padding: "6px 14px",
                              background: "var(--brand, #8b5e34)",
